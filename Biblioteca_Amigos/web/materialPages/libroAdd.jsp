<%-- 
    Document   : LibroAdd
    Created on : May 26, 2026, 6:40:56 PM
    Author     : pdarw
--%>
...
//    materialTypes.put("tesis", Tesis.getTipoCampos());
    ...
    if ("save".equals(step)) {
        ...
        for (String fieldName : fields) {
            ...
            Init.logger.log(Level.WARNING, "Field [" + fieldId + "] raw: " + request.getParameter(fieldId));
            Init.logger.log(Level.WARNING, "Field [" + fieldId + "] otro: " + request.getParameter(fieldId + "_otro"));
            Init.logger.log(Level.WARNING, "Field [" + fieldId + "] final: " + value);
